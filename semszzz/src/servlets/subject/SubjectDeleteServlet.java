...
/* Refresh
 * - 일정 시간 후 서버에 지정된 URL을 요청하게 만듦
 * - 1) 응답헤더에 리프레시 정보 심기
 * - 2) HTML 헤더에 리프레시 정보 심기
 * 
 * Redirect
...
public class SubjectDeleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 1) 응답헤더에 Refresh 명령어 심기
		//response.setHeader("Refresh", "1;url=list.bit?pageNo=1&pageSize=50");
		...
		//		+ " content='1;list.bit?pageNo=1&pageSize=10'>");
